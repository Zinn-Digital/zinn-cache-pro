...
use ZinnCachePro\Admin_Settings;
use ZinnCachePro\Utility;
use WP_CLI;
use WP_Filesystem;
...
class Option extends Base {
	 ...
	 *     $ wp zinn-cache-pro-option set cache-priv false
	 *     $ wp zinn-cache-pro-option set 'cdn-mapping[url][0]' https://cdn.EXAMPLE.com
	 *     $ wp zinn-cache-pro-option set media-lqip_exc $'line1\nline2'
	 *
	 ...
	 *
	 *     # Get all options
	 *     $ wp zinn-cache-pro-option all
	 *     $ wp zinn-cache-pro-option all --json
	 *     $ wp zinn-cache-pro-option all --format=json
	 *
	 ...
	 *
	 *     # Get one option
	 *     $ wp zinn-cache-pro-option get cache-priv
	 *     $ wp zinn-cache-pro-option get 'cdn-mapping[url][0]'
	 *
	 ...
	 *     $ wp zinn-cache-pro-option export
	 *
	 * @param array $args Positional arguments.
	 * @param array $assoc_args Associative arguments.
	 */
	public function export( $args, $assoc_args ) {
		if ( isset( $assoc_args['filename'] ) ) {
			...
			$file = getcwd() . '/zinn_cache_pro_options_' . gmdate( 'd_m_Y-His' ) . '.data';
		}
	 ...
	 *     $ wp zinn-cache-pro-option import options.txt
	 *
	 ...
	 *     $ wp zinn-cache-pro-option import_remote https://domain.com/options.txt
	 *
	 ...
	 *
	 *     # Reset all options
	 *     $ wp zinn-cache-pro-option reset
	 */
