...
use ZinnCachePro\Lang;
use ZinnCachePro\Debug2;
use ZinnCachePro\Img_Optm;
...
class Image {
	 ...
	 *     $ wp zinn-cache-pro-image batch_switch orig
	 *
	 *     # Switch to optimized images
	 *     $ wp zinn-cache-pro-image batch_switch optm
	 *
	 ...
	 *
	 *     # Show optimization status
	 *     $ wp zinn-cache-pro-image status
	 */
	 ...
	 *
	 *     # Remove original image backups
	 *     $ wp zinn-cache-pro-image rm_bkup
	 */
