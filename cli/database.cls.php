...
class Database {
	 ...
	 *     $ wp zinn-cache-pro-database clear_posts
	 *     $ wp zinn-cache-pro-database clear_posts blog 2
	 *
	 ...
	 *     $ wp zinn-cache-pro-database clear_comments
	 *     $ wp zinn-cache-pro-database clear_comments blog 2
	 *
	 * @param string $args Action arguments.
	 */
	 ...
	 *     $ wp zinn-cache-pro-database clear_trackbacks
	 *     $ wp zinn-cache-pro-database clear_trackbacks blog 2
	 *
	 * @param string $args Action arguments.
	 */
	 ...
	 *     $ wp zinn-cache-pro-database clear_transients
	 *     $ wp zinn-cache-pro-database clear_transients blog 2
	 *
	 * @param string $args Action arguments.
	 */
	 ...
	 *     $ wp zinn-cache-pro-database optimize_tables
	 *     $ wp zinn-cache-pro-database optimize_tables blog 2
	 *
	 * @param string $args Action arguments.
	 */
	 ...
	 *     $ wp zinn-cache-pro-database optimize_all
	 *     $ wp zinn-cache-pro-database optimize_all blog 2
	 *
	 * @param string $args Action arguments.
	 */
