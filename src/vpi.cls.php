...
class VPI extends Base {
	 ...
	 * @var string
	 */
	const POST_META = 'zinn_cache_pro_vpi_list';
	/**
	 ...
	 * @var string
	 */
	const POST_META_MOBILE = 'zinn_cache_pro_vpi_list_mobile';
	...
	public function add_to_queue() {
		...
		if ( ! apply_filters( 'zinn_cache_pro_vpi_should_queue', true, $request_url ) ) {
			return;
		}
		...
		$this->_queue[ $queue_k ] = [
			'url'        => apply_filters( 'zinn_cache_pro_vpi_url', $request_url ),
			'post_id'    => $post_id,
