...
class Cloud extends Base {
	...
	public function __construct() {
		...
		if ( defined( 'ZINN_CACHE_PRO_DEV' ) && constant( 'ZINN_CACHE_PRO_DEV' ) ) {
	...
	public function handler() {
		...
		switch ( $type ) {
			...
			case self::TYPE_SYNC_STATUS:
				...
				$msg = __( 'Sync QUIC.cloud status successfully.', 'zinn-cache-pro' );
			...
			case self::TYPE_SYNC_USAGE:
				...
				$msg = __( 'Sync credit allowance with Cloud Server successfully.', 'zinn-cache-pro' );
				Admin_Display::success( $msg );
				break;
