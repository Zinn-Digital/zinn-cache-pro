...
class REST extends Root {
	...
	public function rest_api_init() {
		...
		register_rest_route( 'zinn-cache-pro/v1', '/toggle_crawler_state', [
			'methods'             => 'POST',
		...
		register_rest_route( 'zinn-cache-pro/v1', '/tool/check_ip', [
			'methods'             => 'GET',
		...
		register_rest_route( 'zinn-cache-pro/v1', '/guest/sync', [
			'methods'             => 'GET',
		...
		register_rest_route( 'zinn-cache-pro/v3', '/ip_validate', [
			'methods'             => 'POST',
		...
		register_rest_route( 'zinn-cache-pro/v3', '/wp_rest_echo', [
			'methods'             => 'POST',
			'callback'            => [ $this, 'wp_rest_echo' ],
			'permission_callback' => [ $this, 'is_from_cloud' ],
		] );
		register_rest_route( 'zinn-cache-pro/v3', '/ping', [
			'methods'             => 'POST',
			'callback'            => [ $this, 'ping' ],
			'permission_callback' => [ $this, 'is_from_cloud' ],
		] );
		...
		register_rest_route( 'zinn-cache-pro/v3', '/cdn_status', [
			'methods'             => 'POST',
		...
		// Need validation
		register_rest_route( 'zinn-cache-pro/v1', '/notify_img', [
			'methods'             => 'POST',
			'callback'            => [ $this, 'notify_img' ],
			'permission_callback' => [ $this, 'is_from_cloud' ],
		] );

		register_rest_route( 'zinn-cache-pro/v1', '/notify_ccss', [
			'methods'             => 'POST',
			'callback'            => [ $this, 'notify_ccss' ],
			'permission_callback' => [ $this, 'is_from_cloud' ],
		] );

		register_rest_route( 'zinn-cache-pro/v1', '/notify_ucss', [
			'methods'             => 'POST',
			'callback'            => [ $this, 'notify_ucss' ],
			'permission_callback' => [ $this, 'is_from_cloud' ],
		] );

		register_rest_route( 'zinn-cache-pro/v1', '/notify_vpi', [
			'methods'             => 'POST',
			'callback'            => [ $this, 'notify_vpi' ],
			'permission_callback' => [ $this, 'is_from_cloud' ],
		] );

		register_rest_route( 'zinn-cache-pro/v3', '/err_domains', [
			'methods'             => 'POST',
		...
		// Need validation
		register_rest_route( 'zinn-cache-pro/v1', '/check_img', [
			'methods'             => 'POST',
