...
class Metabox extends Root {
	...
	public function __construct() {
		...
		$this->_postmeta_settings = [
			'zinn_cache_pro_no_cache'        => __( 'Disable Cache', 'zinn-cache-pro' ),
			'zinn_cache_pro_no_image_lazy'   => __( 'Disable Image Lazyload', 'zinn-cache-pro' ),
			'zinn_cache_pro_no_vpi'          => __( 'Disable VPI', 'zinn-cache-pro' ),
			'zinn_cache_pro_vpi_list'        => __( 'Viewport Images', 'zinn-cache-pro' ),
			'zinn_cache_pro_vpi_list_mobile' => __( 'Viewport Images', 'zinn-cache-pro' ) . ' - ' . __( 'Mobile', 'zinn-cache-pro' ),
		];
	}
	...
	public function add_meta_boxes( $post_type ) {
		if ( apply_filters( 'zinn_cache_pro_bypass_metabox', false, $post_type ) ) {
			return;
		}
	...
	public function meta_box_options() {
		require_once ZINN_CACHE_PRO_DIR . 'tpl/inc/metabox.php';
	}
