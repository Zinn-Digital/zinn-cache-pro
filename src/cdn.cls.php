...
class CDN extends Root {
	...
	const BYPASS = 'ZINN_CACHE_PRO_BYPASS_CDN';
	...
	public function init() {
		...
		add_filter( 'zinn_cache_pro_buffer_finalize', [ $this, 'finalize' ], 30 );
	}
	...
	public function rewrite( $url, $mapping_kind, $postfix = false ) {
		...
		if ( ! $is_internal_folder ) {
			self::debug2( '-rewrite failed: path not match: ' . ZINN_CACHE_PRO_CONTENT_FOLDER );
			return false;
		}
