			...
			<React.Fragment>
				...
				<p>
					<button type="button" className="button button-link litespeed-form-action litespeed-link-with-icon" onClick={this.addNew}>
						...
						{zinn_cache_pro_data['lang']['add_cookie_simulation_row']}
					</button>
				</p>
			</React.Fragment>
		);
		...
		return (
			<div className="litespeed-block">
				<div className="litespeed-col-auto">
					<label className="litespeed-form-label">{zinn_cache_pro_data['lang']['cookie_name']}</label>
					<input
						type="text"
						name={zinn_cache_pro_data['ids']['crawler_cookies'] + '[name][]'}
				...
				<div className="litespeed-col-auto">
					<label className="litespeed-form-label">{zinn_cache_pro_data['lang']['cookie_values']}</label>
					<textarea
						rows="5"
						cols="40"
						name={zinn_cache_pro_data['ids']['crawler_cookies'] + '[vals][]'}
						placeholder={zinn_cache_pro_data['lang']['one_per_line']}
				...
				<div className="litespeed-col-auto">
					<button type="button" className="button button-link litespeed-collection-button litespeed-danger" onClick={this.delRow}>
						...
						<span className="screen-reader-text">{zinn_cache_pro_data['lang']['remove_cookie_simulation']}</span>
					</button>
				</div>
			</div>
		);
