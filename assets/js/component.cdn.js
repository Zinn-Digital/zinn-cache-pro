			...
			<React.Fragment>
				...
				<p>
					<button type="button" className="button button-link litespeed-form-action litespeed-link-with-icon" onClick={this.addNew}>
						...
						{zinn_cache_pro_data['lang']['add_cdn_mapping_row']}
					</button>
				</p>
			</React.Fragment>
		);
...
class CDNMappingBlock extends React.Component {
	...
	render() {
		const name_prefix = zinn_cache_pro_data['ids']['cdn_mapping'];
		...
		return (
			<div className="litespeed-block">
				<div className="litespeed-cdn-mapping-col1">
					<label className="litespeed-form-label">{zinn_cache_pro_data['lang']['cdn_mapping_url']}</label>
					<input
						type="text"
					...
					<div className="litespeed-desc">
						<span dangerouslySetInnerHTML={{ __html: zinn_cache_pro_data['lang']['cdn_mapping_url_desc'] }} />
					</div>
				</div>

				<div className="litespeed-col-auto litespeed-cdn-mapping-col2">
					<div className="litespeed-row litespeed-toggle-wrapper">
						<div className="litespeed-cdn-mapping-inc litespeed-form-label litespeed-form-label--toggle">{zinn_cache_pro_data['lang']['cdn_mapping_inc_img']}</div>
						<div
						...
						>
							...
							<div className="litespeed-toggle-group">
								<label className="litespeed-toggle-btn litespeed-toggle-btn-primary litespeed-toggle-on">{zinn_cache_pro_data['lang']['on']}</label>
								<label className="litespeed-toggle-btn litespeed-toggle-btn-default litespeed-toggle-active litespeed-toggle-off">
									{zinn_cache_pro_data['lang']['off']}
								</label>
					...
					<div className="litespeed-row litespeed-toggle-wrapper">
						<div className="litespeed-cdn-mapping-inc litespeed-form-label litespeed-form-label--toggle">{zinn_cache_pro_data['lang']['cdn_mapping_inc_css']}</div>
						<div
					...
					<div className="litespeed-row litespeed-toggle-wrapper">
						<div className="litespeed-cdn-mapping-inc litespeed-form-label litespeed-form-label--toggle">{zinn_cache_pro_data['lang']['cdn_mapping_inc_js']}</div>
						<div
				...
				<div className="litespeed-col-auto">
					<label className="litespeed-form-label">{zinn_cache_pro_data['lang']['cdn_mapping_filetype']}</label>
				...
				<div className="litespeed-col-auto">
					<button type="button" className="button button-link litespeed-collection-button litespeed-danger" onClick={this.delRow}>
						...
						<span className="screen-reader-text">{zinn_cache_pro_data['lang']['cdn_mapping_remove']}</span>
					</button>
				</div>
			</div>
		);
