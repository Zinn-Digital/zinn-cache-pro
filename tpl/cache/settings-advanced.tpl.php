...
<div class="litespeed-callout notice notice-warning inline">
	...
	<p><?php esc_html_e( 'These settings are meant for ADVANCED USERS ONLY.', 'zinn-cache-pro' ); ?></p>
</div>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				<div class="litespeed-desc">
					<?php esc_html_e( 'Specify an AJAX action in POST/GET and the number of seconds to cache that request, separated by a space.', 'zinn-cache-pro' ); ?>
		...
		<tr>
			...
			<td>
				...
				<div class="litespeed-desc">
					<?php esc_html_e( 'Enable this option if you are using both HTTP and HTTPS in the same domain and are noticing cache irregularities.', 'zinn-cache-pro' ); ?>
		...
		<tr>
			...
			<td>
				<?php $this->build_switch( $option_id ); ?>
				<div class="litespeed-desc">
					<?php esc_html_e( 'When a visitor hovers over a page link, preload that page. This will speed up the visit to that link.', 'zinn-cache-pro' ); ?>
					<?php Doc::learn_more( esc_url( 'https://docs.litespeedtech.com/lscache/lscwp/cache/#instant-click' ) ); ?>
					<br />
					<span class="litespeed-danger">
					⚠️
						<?php esc_html_e( 'This will generate extra requests to the server, which will increase server load.', 'zinn-cache-pro' ); ?>
					</span>
				</div>
			</td>
		</tr>
